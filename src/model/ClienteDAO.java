...
// CRUD    
    ...
    private Cliente buildObject(ResultSet rs) {
        ...
        try {
            cliente = new Cliente(rs.getInt("id"), rs.getString("nome"), rs.getString("endereco"), rs.getDate("dataDeNascimento"), rs.getString("cep"), rs.getString("email"), rs.getString("telefone"), rs.getString("cpf"), null);
